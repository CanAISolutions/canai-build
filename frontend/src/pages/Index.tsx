        ...
        <Container>
          ...
          >
            ...
            >
              ...
              <BodyText className="text-lg sm:text-xl opacity-90 drop-shadow-[0_1px_4px_rgba(0,0,0,0.2)] animate-fade-in-up animate-delay-300 max-w-prose mx-auto">
            ...
            <section
              className="animate-fade-in animate-delay-400 mt-6"
            ...
            >
              <CaptionText className="drop-shadow-[0_1px_3px_rgba(0,0,0,0.2)]">
                🚀 3 Core Products • 🎯 Emotionally Intelligent • ✨ Zero Manual
                Touch
              </CaptionText>
            </footer>
          </main>
