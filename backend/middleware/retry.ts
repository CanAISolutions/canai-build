...
export class CircuitBreaker {
  ...
  isOpen(): boolean {
    ...
    if (this.state === 'OPEN' && Date.now() - this.lastStateChange > this.config.alertThreshold) {
...
export function createRetryWrapper(serviceName: string, config?: Partial<RetryConfig>) {
