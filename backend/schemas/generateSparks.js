...
// Joi schema for POST /v1/generate-sparks (F3 Spark Layer)
export const generateSparksSchema = Joi.object({
  ...
  // Add any additional fields required by the PRD for spark generation
});